...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { balance: @balance.balance, is_positive: @balance.is_positive, primary_user: @balance.primary_user, sub_user: @balance.sub_user } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { balance: @balance.balance, is_positive: @balance.is_positive, primary_user: @balance.primary_user, sub_user: @balance.sub_user } }
